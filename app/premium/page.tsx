...
const FEATURES = [
  { title: 'Position prioritaire', desc: 'Votre fiche apparaît en tête de liste dans tous les résultats.' },
  { title: 'Badge identifié', desc: 'Un badge élégant signale votre fiche aux utilisateurs.' },
  { title: 'Page référencée sur Google', desc: 'Page dédiée avec horaires, photos et certifications indexée par Google.' },
]
    ...
    <div style={{ minHeight: '100vh', background: '#f9f8f6', fontFamily: FONT }}>
      ...
      <main style={{ maxWidth: 700, margin: '0 auto', padding: '56px 20px 80px' }}>
        <div style={{ marginBottom: 52 }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '1.4px', textTransform: 'uppercase', color: '#B8860B', margin: '0 0 14px' }}>KosherMap Premium</p>
          ...
          <p style={{ fontSize: 16, color: '#6b7280', lineHeight: 1.65, margin: '0 0 28px', maxWidth: 480 }}>
            Atteignez plus de clients casher en Île-de-France avec une fiche mise en avant.
          </p>
          ...
          <div style={{ background: '#fff', border: '1px solid #ebebeb', borderRadius: 14, padding: '20px 18px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', background: 'rgba(184,134,11,.05)', border: '1px solid rgba(184,134,11,.15)', borderRadius: 10, marginBottom: 6 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ marginBottom: 3 }}><CrownBadge /></div>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#111' }}>La Table de Sarah</div>
              </div>
            </div>
            {['Boulangerie Friedman', 'Épicerie Katz'].map(n => (
              <div key={n} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', opacity: .38, marginBottom: 6 }}>
                <div style={{ width: 36, height: 36, borderRadius: 9, background: '#f3f4f6', flexShrink: 0 }} />
        ...
        {!showCheckout ? (
          <div style={{ background: '#fff', border: '1px solid #ebebeb', borderRadius: 16, padding: '28px 28px 24px' }}>
              ...
              <>
                <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
                  <input value={query} onChange={e => setQuery(e.target.value)}
                    ...
                    placeholder="Nom de votre établissement…" style={{ ...inp, flex: 1 }} />
            ...
            <button onClick={() => selected && setShowCheckout(true)} disabled={!selected} style={{
          ...
          <div style={{ background: '#fff', border: '1px solid #ebebeb', borderRadius: 16, overflow: 'hidden' }}>
            <div style={{ padding: '16px 20px', borderBottom: '1px solid #ebebeb', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button onClick={() => setShowCheckout(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#9ca3af', fontSize: 20, fontFamily: FONT }}>×</button>
            </div>
